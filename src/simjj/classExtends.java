...
// 상속(확장)
// 객체지향 3대 개념 중 하나
// 기존클래스에 기능을 추가하거나 재정의해서 새로운 클래스를 만든는 것

// 상속을 이용하면 기존의 정의되어 있는 클래스의 모든 필드와 메서드를 물려받음
// 기존 클래스를 부모/상위/슈퍼 클래스라 하고
// 새롭게 장성된 클래스를 자식/하위/서브 클래스라 함
...
class Students extends Persons {
    public String study() { return "나는 공부 중..."; }
}

class StudentWorker extends Students {
    public String work() { return "나는 일하는 중...";}
}

class Researcher extends Persons {
    public String research() { return "나는 연구하는 중...";}
}

class Professor extends Researcher {
    public String research() { return "나는 강의 중...";}
}